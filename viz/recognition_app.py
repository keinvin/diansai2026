...
class RecognitionWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.setStyleSheet(
            ...
            "#workspaceTitle { font-size: 40px; font-weight: 700; color: #ffffff; }"
            "#status { font-size: 22px; color: #d3dae5; padding: 4px 10px; }"
            ...
            "#backButton { background: #465465; font-size: 24px; min-height: 54px; }"
            ...
            "#oneClickButton { background: #16734a; font-size: 36px; font-weight: 700; min-height: 122px; padding: 18px 12px; }"
            "#oneClickButton:pressed { background: #0e5235; }"
            "#taskActionButton { font-size: 34px; font-weight: 700; min-height: 122px; }"
            "#executeButton { background: #a66616; font-size: 34px; font-weight: 700; min-height: 122px; }"
            "#taskActionPanel QComboBox { font-size: 28px; font-weight: 700; min-height: 104px; }"
            "#executeButton:pressed { background: #75480d; }"
            "#exitButton { background: #9b3a3a; font-size: 24px; min-height: 54px; }"
